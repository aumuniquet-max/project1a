#import pandas and CONFIG
import pandas as pd
from config import CONFIG
#define a function called mapper that takes one argument which is chunk
def mapper(chunk):
    ...
    #convert age to numeric and drop rows where age is missing
